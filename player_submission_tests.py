...
def correct_open_eval_fn(yourOpenEvalFn):
    ...
    try:
        ...
        # setting up the board as though we've been playing͏︌͏󠄁͏︉
        board_state = [
            [" "," "," "," "," "," "," "],
            [" ","R1","X"," "," "," "," "],
            [" ","X"," "," "," "," "," "],
...
def beat_random(yourAgent):
    ...
    try:
        ...
        # Uncomment to see game͏︌͏󠄁͏︉
        # print game_as_text(winner, move_history, termination, output_b)͏︌͏󠄁͏︉
    except NotImplementedError:
...
def test_minimax_move_selection(yourAgent, minimax_fn):
    ...
    try:
        ...
        # Moving left to (1, 2) leads to more open spaces͏︌͏󠄁͏︉
        # Moving right (1, 4) or (1, 5) leads to being trapped by R3͏︌͏󠄁͏︉
